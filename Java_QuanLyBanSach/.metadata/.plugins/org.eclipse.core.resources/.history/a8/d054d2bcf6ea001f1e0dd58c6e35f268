...
public class DataProvider {
	private static String DB_URL = "jdbc:mysql://localhost:3306/bookstore"; // driver
	...
	public static DataProvider getInstance() {
		if (instance == null) {
			instance = new DataProvider(); // Chỉ tạo đối tượng nếu chưa có
			instance.connect();
		}
		return instance;
	}
	...
	// Open Connection - tạo ra đối tượng kết nối conn
	...
	// - tạo ra đối tượng kết nối conn connection
	 ...
	 * 
	 * cols là danh sách cột cần cập nhật, value là giá trị tương ứng với cột cần
	 * cập nhật.
	 * 
